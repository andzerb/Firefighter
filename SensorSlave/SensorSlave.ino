...
void loop()
{
  ...
  Serial.print("F2M"); Serial.print(flameSensor(flamePins[1])); // Then print the second flame sensor's reading

  Serial.print("F3R"); Serial.print(flameSensor(flamePins[2])); // Then print the second flame sensor's reading
